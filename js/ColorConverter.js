...
function RGBX(r,g,b,a){
  ...
  if( this.total <= 1 ) { this.total = 255; }

  r = Math.round(r / this.total * 255);
  g = Math.round(g / this.total * 255);
  b = Math.round(b / this.total * 255);

  a = (a / this.total).toFixed(2);
